...
func TestConvaiWhatsappOutboundCallWithOptionalParams(t *testing.T) {
	...
	_, err := client.Convai.Whatsapp.OutboundCall(context.TODO(), elevenlabs.ConvaiWhatsappOutboundCallParams{
		AgentID: "agent_id",
