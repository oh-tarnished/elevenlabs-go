...
func TestConvaiBatchCallingGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Convai.BatchCalling.Get(
		context.TODO(),
		"batch_id",
		elevenlabs.ConvaiBatchCallingGetParams{
...
func TestConvaiBatchCallingListWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Convai.BatchCalling.List(context.TODO(), elevenlabs.ConvaiBatchCallingListParams{
		LastDoc:  elevenlabs.String("last_doc"),
		Limit:    elevenlabs.Int(0),
		XiAPIKey: elevenlabs.String("xi-api-key"),
	})
	if err != nil {
		var apierr *elevenlabs.Error
...
func TestConvaiBatchCallingDeleteWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	err := client.Convai.BatchCalling.Delete(
		context.TODO(),
		"batch_id",
		elevenlabs.ConvaiBatchCallingDeleteParams{
			XiAPIKey: elevenlabs.String("xi-api-key"),
		},
	)
	if err != nil {
...
func TestConvaiBatchCallingCancelWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Convai.BatchCalling.Cancel(
		context.TODO(),
		"batch_id",
		elevenlabs.ConvaiBatchCallingCancelParams{
			XiAPIKey: elevenlabs.String("xi-api-key"),
		},
	)
	if err != nil {
...
func TestConvaiBatchCallingRetryWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Convai.BatchCalling.Retry(
		context.TODO(),
		"batch_id",
		elevenlabs.ConvaiBatchCallingRetryParams{
			XiAPIKey: elevenlabs.String("xi-api-key"),
		},
	)
	if err != nil {
...
func TestConvaiBatchCallingSubmitWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Convai.BatchCalling.Submit(context.TODO(), elevenlabs.ConvaiBatchCallingSubmitParams{
		AgentID:  "agent_id",
		CallName: "call_name",
		Recipients: []elevenlabs.ConvaiBatchCallingSubmitParamsRecipient{{
			ID: elevenlabs.String("id"),
			...
			PhoneNumber:    elevenlabs.String("phone_number"),
			WhatsappUserID: elevenlabs.String("whatsapp_user_id"),
		}},
		AgentPhoneNumberID: elevenlabs.String("agent_phone_number_id"),
		ScheduledTimeUnix:  elevenlabs.Int(0),
		...
		WhatsappParams: elevenlabs.BatchCallWhatsappParams{
			...
			WhatsappPhoneNumberID:                             elevenlabs.String("whatsapp_phone_number_id"),
		},
		XiAPIKey: elevenlabs.String("xi-api-key"),
	})
	if err != nil {
