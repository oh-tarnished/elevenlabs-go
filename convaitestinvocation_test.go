...
func TestConvaiTestInvocationGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Convai.TestInvocations.Get(
		context.TODO(),
		"test_invocation_id",
		elevenlabs.ConvaiTestInvocationGetParams{
...
func TestConvaiTestInvocationListWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Convai.TestInvocations.List(context.TODO(), elevenlabs.ConvaiTestInvocationListParams{
		AgentID:  "agent_id",
...
func TestConvaiTestInvocationResubmitWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Convai.TestInvocations.Resubmit(
		context.TODO(),
		"test_invocation_id",
		elevenlabs.ConvaiTestInvocationResubmitParams{
			AgentID:    "agent_id",
			TestRunIDs: []string{"string"},
