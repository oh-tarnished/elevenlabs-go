...
func TestForcedAlignmentNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ForcedAlignment.New(context.TODO(), elevenlabs.ForcedAlignmentNewParams{
		File:               io.Reader(bytes.NewBuffer([]byte("some file contents"))),
		Text:               "text",
		EnabledSpooledFile: elevenlabs.Bool(true),
