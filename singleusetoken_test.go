...
func TestSingleUseTokenNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.SingleUseToken.New(
		context.TODO(),
		elevenlabs.SingleUseTokenNewParamsTokenTypeRealtimeScribe,
		elevenlabs.SingleUseTokenNewParams{
