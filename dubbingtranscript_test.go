...
func TestDubbingTranscriptGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Dubbing.Transcripts.Get(
		context.TODO(),
		elevenlabs.DubbingTranscriptGetParamsFormatTypeSrt,
		elevenlabs.DubbingTranscriptGetParams{
