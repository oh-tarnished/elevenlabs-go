...
func TestTextToDialogueNewWithOptionalParams(t *testing.T) {
	...
	resp, err := client.TextToDialogue.New(context.TODO(), elevenlabs.TextToDialogueNewParams{
		...
		ApplyTextNormalization: elevenlabs.TextToDialogueNewParamsApplyTextNormalizationAuto,
...
func TestTextToDialogueNewWithTimestampsWithOptionalParams(t *testing.T) {
	...
	_, err := client.TextToDialogue.NewWithTimestamps(context.TODO(), elevenlabs.TextToDialogueNewWithTimestampsParams{
		Inputs: []elevenlabs.DialogueInputParam{{
			Text:    "Hello, how are you?",
			VoiceID: "bYTqZQo3Jz7LQtmGTgwi",
		}, {
		...
		OutputFormat:           elevenlabs.AllowedOutputFormatsMP3_22050_32,
		ApplyTextNormalization: elevenlabs.TextToDialogueNewWithTimestampsParamsApplyTextNormalizationAuto,
		LanguageCode:           elevenlabs.String("language_code"),
		ModelID:                elevenlabs.String("model_id"),
		PronunciationDictionaryLocators: []elevenlabs.PronunciationDictionaryVersionLocatorParam{{
			PronunciationDictionaryID: "test",
